...
object ClusterSingletonManager {
  ...
  private object Internal {
    ...
    class OldestChangedBuffer(role: Option[String]) extends Actor {
      ...
      val ageOrdering = Ordering.fromLessThan[Member] { (a, b) ⇒ a.isOlder(b) }
 ...
 * be determined by [[akka.cluster.Member#isOlder]].
 ...
 * ([[akka.cluster.ClusterEvent.Member#isOlder]]) to keep track of oldest member.
